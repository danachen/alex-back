...
describe('Getting words', () => {
    ...
    test('getStatus: status of word 5 for user 1', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        const status = yield words_1.default.getStatus(5, 1);
    ...
    test('updateStatus: change previous status to "familiar"', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        const updatedStatus = yield words_1.default.updateStatus(5, 1, 'familiar');
