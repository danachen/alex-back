...
describe('Getting texts', () => {
    ...
    // });
    test('addNew: add a new text for user 2', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        const textData = {
            userId: 2,
            languageId: 'de',
    ...
    test('getByUser: gets all texts for user 2', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        const userTexts = yield texts_1.default.getByUserAndLanguage(2, 'de');
        expect(userTexts).toHaveLength(1);
    }));
    test('remove: removing an existing text', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        const existingText = yield texts_1.default.getById(3);
        if (existingText === null || existingText === void 0 ? void 0 : existingText.id) {
            ...
            expect(yield texts_1.default.getAll()).toHaveLength(2);
        }
    }));
});
