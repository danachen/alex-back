...
const addMatchGirlToUser = function (userId, languageId) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    INSERT INTO texts (user_id, language_id, author, title, body, ts_config) 
      ...
      RETURNING *`;
        const result = yield (0, db_query_1.default)(ADD_MATCH_GIRL, userId, languageId, languageId, languageId, languageId);
        return result;
    });
};
exports.default = {
